...
GL = GL.GaitLibrary;
for i = 1:length(GL)
    GL{i}.solution.states{3} = MirrorGaitStates(GL{i}.solution.states{1});
    GL{i}.solution.params{3}.atime = MirrorGaitParams(GL{i}.solution.params{1}.atime);
...
save(fullfile('Controllers', 'Yukai', 'mat', 'GaitLibrary_output', 'GaitLibrary_output_up1'), 'GaitLibrary_output');
