...
GL_Data = load('GaitLibrary_LIP_FROST_SOL_v17.mat');
GL = GL_Data.GL_2D;
...
%         if j<=(sGL(2)+1)/2
            ...
            [ ~,~,~,~,~,~,~,~,alpha_output_Right ] = Alpha_Joint_to_Alpha_output( RightStance_Alpha_joint,s,1/GaitLibrary_joint.RightStance.ct(i),M );

            GaitLibrary_output.RightStance.HAlpha(i,j,:,:) = alpha_output_Right;
...
%             GaitLibrary_output.Velocity(2,i,j) = GL{i,j}.SidesSpeed;
            ...
            [ hd_joint,dhd_joint,hd_output,dhd_output,hd_joint_fit,dhd_joint_fit,hd_output_fit,dhd_output_fit,alpha_output_Left ] = Alpha_Joint_to_Alpha_output( LeftStance_Alpha_joint,s,1/GaitLibrary_joint.LeftStance.ct(i),M );

            GaitLibrary_output.LeftStance.HAlpha(i,j,:,:) = alpha_output_Left;
...
save('C:\Users\RoahmLab\Documents\GitHub\Cassie_FlatGround_Controller\Controllers\Flatground\mat\GaitLibrary_LIP_v17.mat','GaitLibrary_output')